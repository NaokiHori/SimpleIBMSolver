...
static fluid_t *allocate(const domain_t * restrict domain){
  ...
  fluid->ux  = common_calloc( UX_SIZE_0 *  UX_SIZE_1, sizeof(double));
  fluid->uy  = common_calloc( UY_SIZE_0 *  UY_SIZE_1, sizeof(double));
  fluid->p   = common_calloc(  P_SIZE_0 *   P_SIZE_1, sizeof(double));
  fluid->psi = common_calloc(PSI_SIZE_0 * PSI_SIZE_1, sizeof(double));
  /* ! Runge-Kutta source terms are allocated ! 6 ! */
  fluid->srcuxa = common_calloc(SRCUXA_SIZE_0 * SRCUXA_SIZE_1, sizeof(double));
  fluid->srcuxb = common_calloc(SRCUXB_SIZE_0 * SRCUXB_SIZE_1, sizeof(double));
  fluid->srcuxg = common_calloc(SRCUXG_SIZE_0 * SRCUXG_SIZE_1, sizeof(double));
  fluid->srcuya = common_calloc(SRCUYA_SIZE_0 * SRCUYA_SIZE_1, sizeof(double));
  fluid->srcuyb = common_calloc(SRCUYB_SIZE_0 * SRCUYB_SIZE_1, sizeof(double));
  fluid->srcuyg = common_calloc(SRCUYG_SIZE_0 * SRCUYG_SIZE_1, sizeof(double));
  return fluid;
}
